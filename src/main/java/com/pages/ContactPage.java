...
public class ContactPage {
	...
	public void enterContactInfo(String fn, String ln, String mail, String pn, String c) {
		...
		titleE.selectByVisibleText("Automate Contact");
	...
	public void enterUsersInfo(String el, String c) throws InterruptedException {
		try {
			...
			objSelect.selectByVisibleText("Automate Contact");
			driver.findElement(emailid).clear();
			driver.findElement(emailid).sendKeys(el);
			Thread.sleep(1000);
			driver.findElement(By.xpath("//input[@id='contact_image']"))
					.sendKeys("E:\\Rahul Bhalla CIS\\OntrackProjectBDD\\OnTrack_BDD\\Image\\download.jpg");
	...
	public String getContactDetailStatus() {
		driver.manage().timeouts().implicitlyWait(Duration.ofMinutes(20));
		return driver.findElement(By.xpath("//span[contains(text(),'Automate Contact')]")).getText();
	}
	...
	public void enterOldUsersInfo(String tl, String el) {
		...
		try {
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//input[@id='contact_image']"))
					.sendKeys("E:\\Rahul Bhalla CIS\\OntrackProjectBDD\\OnTrack_BDD\\Image\\Audi.png");
	...
	public void uploadImage() {
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.findElement(By.xpath("//input[@id='photoInput']"))
				.sendKeys("E:\\Rahul Bhalla CIS\\OntrackProjectBDD\\OnTrack_BDD\\Image\\aaa.png");
		driver.navigate().refresh();
	}
	...
	public String getAddTitleStatusContactTitleWidget() {
		return driver.findElement(By.xpath("//td[contains(text(),'Automate Contact')]")).getText();
	}
